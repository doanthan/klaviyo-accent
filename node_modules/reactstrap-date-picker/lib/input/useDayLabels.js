...
exports.useFixedDayLabels = void 0;
...
var useFixedDayLabels = (dayLabels, weekStartsOn) => {
  var [fixedDayLabels, setFixedDayLabels] = (0, _react.useState)(_getFixedDayLabels(dayLabels, weekStartsOn));
  (0, _react.useEffect)(() => {
    setFixedDayLabels(_getFixedDayLabels(dayLabels, weekStartsOn));
  }, [dayLabels, weekStartsOn]);
  return fixedDayLabels;
};
exports.useFixedDayLabels = useFixedDayLabels;