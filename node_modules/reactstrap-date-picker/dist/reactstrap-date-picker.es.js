...
var useInputValues = (controlInputRef, value, defaultValue, minDate, maxDate, dateFormat, onClear, onChange) => {
  ...
  var handleBadInputOnBlur = () => {
    ...
    var originalValue = (controlInputRef === null || controlInputRef === void 0 ? void 0 : (_controlInputRef$curr = controlInputRef.current) === null || _controlInputRef$curr === void 0 ? void 0 : _controlInputRef$curr.value) || '';
    if (originalValue) {
  ...
  var handleInputChange = /*useCallback(*/() => {
    ...
    var originalValue = (controlInputRef === null || controlInputRef === void 0 ? void 0 : (_controlInputRef$curr2 = controlInputRef.current) === null || _controlInputRef$curr2 === void 0 ? void 0 : _controlInputRef$curr2.value) || '';
...
var propRef = PropTypes.oneOfType([PropTypes.func, PropTypes.shape({
  current: PropTypes.oneOfType([PropTypes.instanceOf(Element), PropTypes.any])
})
//PropTypes.shape({ current: PropTypes.any })
]);

var propElemOrString = PropTypes.oneOfType([PropTypes.string, PropTypes.object]);
...
var calendarProps = {
  ...
  pickMonthElement: PropTypes.oneOfType([PropTypes.string, PropTypes.func, PropTypes.element]),
  ...
  target: PropTypes.oneOfType([PropTypes.string, propRef]),
  calendarContainer: PropTypes.oneOfType([PropTypes.string, propRef])
};
...
var DatePicker = /*#__PURE__*/forwardRef(_DatePicker);
